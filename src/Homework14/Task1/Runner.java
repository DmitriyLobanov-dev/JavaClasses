...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        petsMap.put(new Parrot("Kilmister", "just cat", 2, false), new Doctor("Dr.Acula", 666));
        ...
        ParrotNameComparator comparator = new ParrotNameComparator();

        Map<Parrot, Doctor> petsMap2 = new TreeMap<>(comparator);
        petsMap2.put(new Parrot("Mr.Anderson", "Jack Daniels", 2, false), new Doctor("Dr.Acula", 666));
        petsMap2.put(new Parrot("Mr. Meeseeks", "just cat", 2, false), new Doctor("Dr.Acula", 666));
        petsMap2.put(new Parrot("Mr. Meeseeks", "Ara yellow-blue", 2, false), new Doctor("Dr.Acula", 666));
